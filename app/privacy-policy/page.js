...
export default function PrivacyPolicyPage() {
  return (
    <div className="w-full bg-white overflow-x-hidden motion-scope">
      ...
      <main className="w-full pt-[120px] sm:pt-[136px] xl:pt-[221px] pb-12 sm:pb-16 xl:pb-[97px] px-4 sm:px-6 xl:px-num-119">
        <Container className="prose-legal flex flex-col gap-6 text-black">
