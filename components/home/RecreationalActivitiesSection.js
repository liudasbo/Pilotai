...
export default function RecreationalActivitiesSection() {
  return (
    <section
      id="activities"
      data-motion="reveal"
      className="w-full bg-whitesmoke-100 py-16 sm:py-20 desktop:py-[112px] 2xl:py-[132px] px-4 sm:px-6 lg:px-10 xl:px-16 2xl:px-24 box-border"
    >
      <Container className="grid grid-cols-1 gap-10 xl:grid-cols-[536px_760px] xl:items-end xl:gap-[52px]">
        <section className="flex flex-col items-start justify-end pt-0 px-0 pb-[8.2px] box-border w-full text-left text-num-37 text-black font-jost">
        ...
        <section className="w-full min-h-[320px] sm:min-h-[420px] lg:min-h-[460px] xl:min-h-[520px] overflow-hidden relative max-w-full">
          <Image quality={90}
