...
export default function RecreationalActivitiesSection() {
  return (
    <section className="w-full bg-whitesmoke-100 flex items-end justify-center py-16 sm:py-20 desktop:py-[147px] px-4 sm:px-6 desktop:px-[119px] box-border gap-10 desktop:gap-[52px] flex-col desktop:flex-row">
      <section className="flex flex-col items-start justify-end pt-num-0 px-num-0 pb-[8.2px] box-border w-full max-w-[536px] text-left text-num-37 text-black font-jost">
        <div className="w-full flex flex-col items-start gap-8 desktop:gap-9 max-w-full">
          <div className="self-stretch flex flex-col items-start gap-5">
            <h1 className="m-0 w-full max-w-[381.7px] relative text-[30px] leading-[36px] desktop:text-[length:inherit] tracking-num-0_56 desktop:leading-num-42 uppercase font-medium font-[inherit] flex items-center">
      ...
      <section className="w-full desktop:w-auto min-h-[420px] sm:min-h-[520px] desktop:min-h-[650px] bg-darkslategray-200 overflow-hidden flex flex-col items-end justify-between pt-16 sm:pt-20 desktop:pt-[134px] px-6 sm:px-10 desktop:px-[79px] pb-10 sm:pb-12 desktop:pb-[40px] box-border relative isolate max-w-full text-right text-[7.2px] text-gray-300 font-jost">
        ...
        <div className="flex items-start justify-end py-num-0 pl-10 sm:pl-[132px] pr-0 desktop:pr-[313px] shrink-0 z-[1]">
