...
export default function HeroSection() {
  return (
    <main className="w-full min-h-[760px] sm:min-h-[800px] desktop:min-h-[900px] bg-blanchedalmond flex flex-col items-start pt-0 px-0 box-border relative isolate">
      <Image
