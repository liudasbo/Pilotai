...
export default function UltralightLicenseSection() {
  return (
    <section className="self-stretch bg-whitesmoke-100 shrink-0 flex flex-col items-start py-16 sm:py-20 desktop:py-[86px] px-4 sm:px-6 desktop:px-num-119 box-border max-w-full">
      <div className="section-container flex flex-col gap-10 desktop:flex-row desktop:items-center desktop:gap-28">
        ...
        <section className="w-full desktop:w-[531px] flex flex-col items-start py-0 desktop:py-num-20 px-0 box-border gap-8 desktop:gap-9 max-w-full text-left text-num-37 text-black font-jost">
          <div className="w-full flex flex-col items-start gap-[9px]">
            <h1 className="section-heading w-full max-w-[447.6px] relative flex items-center">
          ...
          <button className="cta-button-base cta-button-accent px-10 flex flex-col items-center justify-center">
